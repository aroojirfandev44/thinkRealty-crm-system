...
//   console.log("!!(timers[unit.unit_id] && timers[unit.unit_id] > Date.now())")
//   return (
//     <>
...
//               console.log("!!(timers[unit.unit_id] && timers[unit.unit_id] > Date.now())", isLocked)
//               return (
//                 <label
//                   key={unit.unit_id}
...
//                   </p>
//                   {timers[unit.unit_id] && <TimerDisplay expiresAt={timers[unit.unit_id]} />}
          ...
          {layoutMode.isPerformance && (
            <div className="flex justify-between items-center mt-6 px-2">
              <button
                onClick={handlePrevPage}
                disabled={currentPage === 1}
                className="flex items-center gap-2 px-4 py-2 text-sm border border-gray-300 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed bg-white hover:bg-gray-50 transition-colors"
              >
